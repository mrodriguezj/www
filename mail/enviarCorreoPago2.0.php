...
// Nueva consulta SQL con total pagado y última fecha de pago
$sql = "
SELECT
    cp.id_calendario,
    cp.numero_pago,
...
try {
    ...
    $mail->AltBody = "Hola $nombreCliente, tu pago total hasta la fecha es $$totalPagado. Último pago realizado el $ultimaFechaPago. Estatus: $estatusPago. Monto restante: $$montoRestante.";
